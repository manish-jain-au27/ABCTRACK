      ...
      <div>
        <div className="ng-star-inserted">
          <div className="container-fluid">
            ...
            <div className="row">
              {/* Create Task Button */}
              <div className="form-group col-lg-12 d-flex justify-content-end align-items-center" style={{ marginTop: '15px' }}>
                <button
            ...
            {isCreateTaskModalOpen && (
              <div className={`task-modal-overlay ${isCreateTaskModalOpen ? 'open' : ''}`} onClick={() => setIsCreateTaskModalOpen(false)}>
                ...
                <h5 className="modal-title ubuntu-font ubuntu-bold">Create Assignment</h5>
                          ...
                          <div className="input-group justify-content-center" style={{width: 'auto'}}>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                handleTaskDetailChange('ratePerHour', isNaN(newRate) ? 500 : newRate);
                              }}
                              min="0"
                              step="50"
                            />
...
export default connect(mapStateToProps, { notifyGeneralInfo })(CreateTask);